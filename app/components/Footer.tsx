        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Tu aliado en logística. Fletes y mudanzas profesionales en Quilmes, CABA y GBA.
              Equipo experto, entregas puntuales.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#galeria" className="text-gray-400 hover:text-primary transition-colors">
                  Galería
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-start">
                ...
                <a href="tel:+5491151747499" className="hover:text-primary transition-colors">
                  +54 9 11 5174-7499
                </a>
              </li>
              <li className="flex items-start">
                ...
                <span>7 a 22 hs - Todos los días</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-0.5 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
