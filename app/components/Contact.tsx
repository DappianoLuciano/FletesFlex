...
export default function Contact() {
  ...
  return (
    <section id="contacto" className="py-12 bg-gradient-to-br from-accent via-[#34495e] to-[#2c3e50] relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <span className="text-primary font-bold text-sm uppercase tracking-wider">Hablemos</span>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all">
              <div className="text-center">
                ...
                <a
                  ...
                  className="text-primary text-sm font-semibold hover:text-[#e89610] transition-colors"
                >
                  +54 9 11 5174-7499
                </a>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all">
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm mb-3">Seguinos y mirá nuestro trabajo</p>
                <a
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
              <div className="text-center">
                ...
                <p className="text-gray-300 font-semibold">7 a 22 hs</p>
          ...
          <div className="lg:mt-0">
            <div className="bg-white rounded-3xl p-12 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-primary text-white text-center px-8 py-4 rounded-full font-bold hover:bg-[#e89610] transition-all transform hover:scale-105 shadow-lg flex items-center justify-center"
                >
